...
export default function PaymentComponent({ billed, setBilled, paymentMethod, setPaymentMethod }) {
  ...
  return (
    <div className='w-[65%] h-screen flex flex-col items-center p-8 bg-white'>
      <div>
      ...
      <div className='flex space-x-24'>
            ...
            <div className={`p-8 rounded-lg border  space-y-1 ${billed == 'Yearly' ? 'border-blue-500' : 'border-gray-300'}`}>
                ...
                <p>BDT. 149 / month</p>
                <p className='text-sm text-gray-500'>(549.00 BDT billed annually)</p>
            </div>
      </div> 
